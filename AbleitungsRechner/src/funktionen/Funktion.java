...
public abstract class Funktion {
	public static int KLAMMER_BREITE = 0;
	private static boolean debuggen = false;

	public static void klammern(Funktion f) {
	...
	public abstract void zusammenfügen();
	...
	public boolean kollision(int x, int y, int xKlick, int yKlick) {
		return (new Rectangle(x - (halbeBreite()), y - (halbeHöhe()), breite(), höhe())).contains(
				xKlick, yKlick);
	}
}
